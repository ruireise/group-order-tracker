  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className="flex justify-between items-center cursor-move" // Apply cursor-move to the header only
        ...
        >
          ...
          <button
            ...
            style={{ pointerEvents: 'auto' }} // Ensure the close button remains interactive
          >
            ✖
          </button>
        </div>
